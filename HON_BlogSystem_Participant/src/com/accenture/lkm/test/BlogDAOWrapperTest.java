 ...
 */
  ...
  public void testAddBlog() throws Exception {
	  ...
	  blogBean.setEmail("dummyemail@gmail.com");
	  blogBean.setThemes("dummytheme");
	 int id =  blogDAOWrapper.addblog(blogBean);
 ...
 */
	...
	public void testFindPostsByEmail() throws Exception {
		...
		List<BlogBean> blogBeanList = blogDAOWrapper.findPostsByEmail("bg66@gmail.com");
		Assert.assertTrue(blogBeanList.size() != 0);
  ...
  */
  ...
  public void testCountPostsByEmail() {
	 ...
	 long count =  blogDAOWrapper.countPostsByEmail("kutty66@gmail.com");
