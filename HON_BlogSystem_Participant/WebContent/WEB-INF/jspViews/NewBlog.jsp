...
-->
			...
			<table border="1">
				...
				<tr>
					...
					<td><form:errors class="error" path="title"></form:errors></td>
				...
				<tr>
					...
					<td><form:select path="themes">
							...
							<form:options items="${themes}"></form:options>
						</form:select>
					</td>
				...
				<tr>
					...
					<td><form:errors class="error" path="content"></form:errors></td>

				</tr>

				<tr>
					<td colspan="2" align="center">
						<!-- Add submit button here --> <input type="submit"
						value="Create Blog">
					</td>
